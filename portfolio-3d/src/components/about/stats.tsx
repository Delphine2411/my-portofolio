...
const translations = {
  fr: {
    stats: [
      { label: "Projets total", value: 11, key: "projects" },
      { label: "Clients heureux", value: 7, key: "clients" },
      { label: "Projets personnels", value: 4, key: "awards" },
      { label: "Années d'expérience", value: 1, key: "Months" },
    ],
  },
  en: {
    stats: [
      { label: "Completed Projects", value: 11, key: "projects" },
      { label: "Happy Clients", value: 7, key: "clients" },
      { label: "Personal Projects", value: 4, key: "awards" },
      { label: "Years of Experience", value: 1, key: "Months" },
    ],
  },
  es: {
    stats: [
      { label: "Proyectos terminados", value: 11, key: "projects" },
      { label: "Clientes satisfechos", value: 7, key: "clients" },
      { label: "Proyectos personales", value: 4, key: "awards" },
